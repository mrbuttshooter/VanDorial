...
def test_zone_pairs_start_with_zone_codes(zones):
    ...
    for a, b in pairs:
        ...
        # Valid E.164 lengths: Nigeria-Lagos 2341 -> 11 (landline sub-country
        # override), Guinea 224 -> 12 — NOT a flat length (a wrong-length dialed
        # number is what MADA 404'd).
...
def test_e164_length_by_country_and_override():
    ...
    assert g.e164_total_length("234", 11) == 13          # Nigeria mobile (country default)
    assert g.e164_total_length("2341", 11) == 11         # Nigeria-Lagos landline (sub-country override)
